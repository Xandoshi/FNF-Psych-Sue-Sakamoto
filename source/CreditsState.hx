...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Vs Sue Sakamoto'],
			['Xandoshi',		'xandoshi',		'Creator of Vs Sue Sakamoto',						'https://twitter.com/Xandoshi',	'c00000'],
			['Studio Pixel',			'studiopixel',		'Creator of Cave Story and Music',					'https://twitter.com/studiopixeljp',		'0076b4'],
			['SiIvagunner',			'siivagunner',			'Creator of the Quote and Curly Skins and Game Over Music',				'https://www.youtube.com/c/SiIvaGunner',			'434253'],
			['Psych Engine Team'],
