...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'mimiga': //Week TEMPLATE
				var bg:BGSprite = new BGSprite('sue_back', -300, -100, 1.0, 1.0);
				add(bg);

				var middlebackground:BGSprite = new BGSprite('sue_mid', -300, -190, 1.0, 1.0);
				middlebackground.setGraphicSize(Std.int(middlebackground.width * 1.0));
				middlebackground.updateHitbox();
				add(middlebackground);

				var stageFront:BGSprite = new BGSprite('sue_front', -300, 320, 1.0, 1.0);
